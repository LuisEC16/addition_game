...
<body>
    ...
    <div class="exercise-list">
        <?php foreach ($ejercicios as $ejercicio): ?>
            ...
            <?php else: ?>
                <a href="level3_exercise.php?ejercicio_id=<?php echo $ejercicio['id']; ?>">
    ...
    <?php if ($todosCompletados): ?>
        <div>
            <form action="level4.php" method="GET">
                <button type="submit">Pasar al ejercicio 4</button>
            </form>
        </div>
    <?php endif; ?>
    <div>
        <form action="level2.php" method="GET">
            <button type="submit">Volver al ejercicio 2</button>
        </form>
    </div>
