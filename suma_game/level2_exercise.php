...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($respuestaUsuario === (string)$respuestaCorrecta) {
        marcarEjercicioCompletado(2, $ejercicio_id);
        header("Location: level2.php?respuesta=correcta");
        exit();
    } else {
...
<body>
    ...
    <div class="sum-container">
        ...
        <div class="line"></div>
        <form method="POST" action="level2_exercise.php?ejercicio_id=<?php echo $ejercicio_id; ?>">
    ...
    <a href="level2.php">Volver a la selección de ejercicios</a>
