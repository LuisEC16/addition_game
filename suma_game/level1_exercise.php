...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($respuestaUsuario === (string)$respuestaCorrecta) {
        marcarEjercicioCompletado(1, $ejercicio_id);
        header("Location: level1.php?respuesta=correcta");
        exit();
    } else {
...
<body>
    ...
    <div class="sum-container">
        ...
        <div class="line"></div>
        <form method="POST" action="level1_exercise.php?ejercicio_id=<?php echo $ejercicio_id; ?>">
    ...
    <a href="level1.php">Volver a la selección de ejercicios</a>
